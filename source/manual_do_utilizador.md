...
[1. Conceitos básicos](#conceitos-basicos)
  ...
  [1.2 Tipos de contas](#tipos-de-contas)
    [1.2.1 Qual é o meu tipo de conta?](#qual-e-o-meu-tipo-de-conta)
  [1.3 Editar dados no Catechesis](#editar-dados-no-catechesis)
[2. Efectuar uma tarefa](#efectuar_uma_tarefa)
  [2.1 Modificar os dados da minha conta](#modificar_os_dados_da_minha_conta)
  [2.2 Consultar as fichas dos meus catequizandos](#consultar_as_fichas_dos_meus_catequizandos)
  [2.3 Imprimir folha de presenças, fichas de catequizandos ou fichas de pré-inscrição](#imprimir-folha-de-presen?as-fichas-de-catequizandos-ou-fichas-de-pre-inscricao)
    [2.3.1 Para o meu grupo de catequese](#para-o-meu-grupo-de-catequese)
    [2.3.2 Para outro grupo de catequese](#para-outro-grupo-de-catequese)
  [2.4 Inscrever um catequizando](#inscrever-um-catequizando)
    [2.4.1 Inscrever um novo catequizando](#inscrever-um-novo-catequizando)
    [2.4.2 Inscrever um irmão](#inscrever-um-irmao)
  [2.5 Procurar e consultar a ficha de um catequizando](#procurar-e-consultar-a-ficha-de-um-catequizando)
    [2.5.1 Procurar por nome / data de nascimento](#procurar-por-nome-data-de-nascimento)
    [2.5.2 Procurar por ano / catecismo](#procurar-por-ano-catecismo)
    [2.5.3 Procurar por catequista](#procurar-por-catequista)
  [2.6 Consultar o arquivo acerca de um catequizando](#consultar-o-arquivo-acerca-de-um-catequizando)
  [2.7 Registar o  aproveitamento dos catequizandos](#registar-o-aproveitamento-dos-catequizandos)
    [2.7.1 Registar o aproveitamento dos meus catequizandos](#registar-o-aproveitamento-dos-meus-catequizandos)
    [2.7.2 Abrir/fechar o periodo de avaliação](#abrir-fechar-o-per?odo-de-avaliacao)
  [2.8 Atribuir um catequizando a um grupo de catequese](#atribuir-um-catequizando-a-um-grupo-de-catequese)
  [2.9 Renovar matrículas](#renovar-matriculas)
  [2.10 Criar e gerir grupos de catequese](#criar-e-gerir-grupos-de-catequese)
    [2.10.1 Criar novos grupos de catequese](#criar-novos-grupos-de-catequese)
    [2.10.2 Definir os catequistas para um grupo de catequese](#definir-os-catequistas-para-um-grupo-de-catequese)
  [2.11 Criar e gerir utilizadores e catequistas](#criar-e-gerir-utilizadores-e-catequistas)
    [2.11.1 Criar uma nova conta de utilizador / catequista](#criar-uma-nova-conta-de-utilizador-catequista)
    [2.11.2 Modificar a conta de um utilizador](#modificar-a-conta-de-um-utilizador)
  [2.12 Gerar listagens de catequizandos](#gerar-listagens-de-catequizandos)
  [2.13 Consultar/Imprimir sacramentos de todos os catequizandos](#consultar-imprimir-sacramentos-de-todos-os-catequizandos)
  [2.14 Consultar estatisticas acerca da catequese paroquial](#consultar-estat�sticas-acerca-da-catequese-paroquial)
  [2.15 Monitorizar os acessos ao CatecheSis](#monitorizar-os-acessos-ao-catecheSis)
...
Aceda a _Minha Conta_ e observe o painel _Os meus grupos de catequese_. É apresentado o(s) seu(s) grupo(s) de catequese neste ano catequético.
...
_Adicionar/remover grupos num ano catequético existente_
...
Um ícone verde indica que o sacramento em causa foi realizado na Paróquia da Cova da Piedade. Um ícone cinzento indica que o sacramento foi realizado noutra paróquia.
...
_Número de catequizandos por catequista_
...
_Percursos catequéticos completos_
...
_Percentagem de catequizandos residentes na paróquia_
